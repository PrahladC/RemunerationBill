...
public class RemunerationBill extends JDialog {
	...
	public static void main(String[] args) {
		try {
			  RemunerationBill dialog = new RemunerationBill();
	 ...
	 * Create the dialog.
	 */
	public RemunerationBill() {
		setTitle("Practical - Remuneration Bill");
		frame = new JFrame("Remuneration Bill");
		setBounds(100, 0, 500, 600);
		GridBagLayout gridBagLayout = new GridBagLayout();
		gridBagLayout.columnWidths = new int[]{147, 0, 0, 0};
		gridBagLayout.rowHeights = new int[] {0, 205, 33, 0, 0, 0, 0, 0, 0, 7, 41, 21, 10};
		...
		}
		{
			...
			gbc_lblEnterBillerName.gridx = 1;
